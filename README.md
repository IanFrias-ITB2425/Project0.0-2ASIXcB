...
| **Base de Datos (B-NCC)** | MySQL con datos de OpenData BCN cargados. | [📄 Ver README BBDD](./database/README.md) |
| **DNS / DHCP** | Resolución de nombres (incluyendo R-NCC) y asignación de IPs. | [📄 Ver README Red](./network_services/README.md) |
| **FTP (F-NCC)** | Servidor de transferencia de archivos. | [📄 Ver README FTP](./ftp/README.md) |
| **SSH** | Configuración de acceso remoto seguro. | [📄 Ver README SSH](./ssh/README.md) |
